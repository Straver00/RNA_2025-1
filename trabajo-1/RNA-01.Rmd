...
```{r functions_to_optimize, echo = FALSE}
...
```{r def_gradient_descent, echo = FALSE}
...
```{r grad_rosenbrock2D, echo = FALSE}
...
```{r simulation_rastrigin, fig.align='center', fig.cap="***Fig.21** Comparación Rastrigin*", echo = FALSE}
...
```{r simulation_rosenbrock, fig.align='center', fig.cap="***Fig.22** Comparación Rosenbrock*", echo = FALSE}
