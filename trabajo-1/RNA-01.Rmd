...
5.  [Reporte de Contribución Individual](#reporte-de-contribución-individual)
...
La función de **Rastrigin** se define a continuación con la ecuación (1):
...
Luego, la de **Rosenbrock** se define como describe ahora la ecuación (2):
...
Tras las ejecuciones realizadas en materia de experimentaciones iniciales, ejecuciones oficiales en el reporte técnico, los análisis a partir de los GIF en complemento con la teoría conocida del curso y las discuciones de clase, se puede concluir lo siguiente:
  ...
  - Como mostró Korniienko et al. (2024), el mejor enfoque es combinar ambos mundos: usar GD donde la topografía es suave y unimodal, y metaheurísticos cuando se espera alta multimodalidad o cuando no se dispone de derivadas analíticas.
