...
- La optimización combinatoria, a partir de un problema clásico de la vida real, como es el problema del vendedor viajero, en un escenario particular como lo es la geografía colombiana.

El objetivo será entonces por medio de estos ejes principales, comprender la importancia, aplicabilidad y ventajas de estos algoritmos, entendiendo que son una base fundamental para las grandes tecnologías de hoy.
